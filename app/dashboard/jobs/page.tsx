...
const Page = () => {
    ...
    return (
        <div>
            ...
            <div className='w-full border h-fit bg-[#F4F4F5]'>

                <div className='border h-24 w-full mt-5 flex flex-col justify-center px-3'>
                    <h3 className='text-3xl font-bold'>Jobs</h3>
                    <p className='text-[18px] font-medium'>showing 30 of 500 jobs</p>
                </div>

                <div className='border w-full h-fit md:h-300 p-3 md:p-0'>
                    <div className='border w-full h-fit md:h-250 grid lg:grid-cols-3 gap-5 md:gap-4 md:grid-cols-2 md:px-2 grid-cols-1 overflow-y-scroll pt-5'>
                        {
                            jobss.map((job, index) => (
                                <form key={index} className='bg-white lg:min-h-85 md:min-h-110 h-95 rounded-2xl shadow-lg '>
